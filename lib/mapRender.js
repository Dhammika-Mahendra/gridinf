...
function renderRegions(gMap,pathGenerator, correctedData) {
...
function renderLabels(gMap,pathGenerator, correctedData, transform) {

  let labels = correctedData.features.map(d => {
